...
extern const unsigned char image_back50[]; // BITMAP_BACK50_ID = 1, Size: 50x50 pixels
...
extern const unsigned char image_button_pressed[]; // BITMAP_BUTTON_PRESSED_ID = 6, Size: 130x56 pixels
extern const unsigned char image_button_released[]; // BITMAP_BUTTON_RELEASED_ID = 7, Size: 130x56 pixels
extern const unsigned char image_configuration[]; // BITMAP_CONFIGURATION_ID = 8, Size: 48x48 pixels
